...
const Home = () => {
  const itemOneGeneral = useRef();
  const itemTwoGeneral = useRef();
  const itemThreeGeneral = useRef();
  const itemFourGeneral = useRef();
  const itemFiveGeneral = useRef();
  const itemSixGeneral = useRef();
  const itemOne = useRef();
  const itemTwo = useRef();
  const itemThree = useRef();
  const itemFour = useRef();
  const itemFive = useRef();
  const itemSix = useRef();
  const itemOneTitle = useRef();
  const itemTwoTitle = useRef();
  const itemThreeTitle = useRef();
  const itemFourTitle = useRef();
  const itemFiveTitle = useRef();
  const itemSixTitle = useRef();
  ...
  return <div className={homeStyle.card}>
      <Title></Title>
      <Info></Info>
      ...
      <div className={homeStyle.BelowInfo}>
        ...
        <div className={homeStyle.BelowBoxes}>
          ...
          <div>
            <Image src={conversionReady} alt="conversionReady" width={48} height={48} />
        ...
        <div className={homeStyle.FreqAskQuestions}>
          ...
          <div className={homeStyle.FreqAskQuestionsElements}>
            {infoItemList.map(i => {
            return <div key={i.id} ref={i.refGeneral}>
                  <div onClick={() => {
                ...
                i.setIsChecked(!i.isChecked);
                    ...
                    {i.isChecked ? <RemoveCircleOutlineIcon className="text-purple-800 m-4" /> : <AddCircleOutlineIcon className="m-4" />}
                  </div>
          ...
          <div className={homeStyle.Targeting}>
            <div className={homeStyle.TargetingWrapper}>
              <div className={homeStyle.TargetingIMGWrapper}>
                <Image src={TargetingOptions1} alt="TargetingOptions1" width={70} height={70} />
              </div>
